...
//         this.state = {
//             recipe: recipe,
//             url: `https://www.food2fork.com/api/get?key=7f9ce7d8150927d3606dc37f81119730&rId=${this.props.id}`
//         };
//     }   
...
//   }
    ...
    async componentDidMount()
    {
        ...
        const url = `https://www.food2fork.com/api/get?key=7f9ce7d8150927d3606dc37f81119730&rId=${id}`;
        try{
               ...
               <div className="container">
                   <div className="row">
                       <div className="col-10 mx-auto col-md-6 my-3">
                           ...
                           <img src={image_url} className="d-block w-100" alt="dish"/>
                       </div>
                       <div className="col-10 mx-auto col-md-6 my-3">
